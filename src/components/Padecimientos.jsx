    ...
    <section className="py-20 bg-slate-50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 flex flex-row lg:flex-col overflow-x-auto lg:overflow-x-visible pb-4 lg:pb-0 gap-3 no-scrollbar">
              ...
              {padecimientos.map((pad) => {
                ...
                return (
                  <motion.div
                    ...
                    className="glass-panel p-8 sm:p-12 rounded-3xl border border-white/60 shadow-xl text-left space-y-6 flex flex-col justify-between h-full"
                  >
                    <div>
                      {/* Subtitle */}
                    ...
                    <div className="pt-6 border-t border-slate-100 mt-6 flex justify-end">
                      <button
                        ...
                        className="w-full sm:w-auto bg-gradient-to-r from-primary to-secondary hover:opacity-95 text-white font-bold px-8 py-4 rounded-xl shadow-lg shadow-secondary/20 flex items-center justify-center gap-2 cursor-pointer text-sm"
                      >
